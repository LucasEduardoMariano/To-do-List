...
public class CommonContants { 
    ...
    public static final Dimension GUI_SIZE = new Dimension (560,600);
    
    public static final Dimension BANNER_SIZE = new Dimension (GUI_SIZE.width,50);
    
    public static final Dimension TASKPANEL_SIZE = new Dimension (GUI_SIZE.width - 30,GUI_SIZE.width - 175);
    
    public static final Dimension ADDTASK_BUTTON_SIZE = new Dimension (GUI_SIZE.width - 30,50);
